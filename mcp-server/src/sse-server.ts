...
app.get('/health', (_req, res) => {
  res.json({ status: 'ok', service: 'gtd-buddy-mcp-sse' });
});
...
app.get('/sse', async (req, res) => {
  ...
  // Handle tool calls (same implementation as stdio version)
...
app.listen(PORT, () => {
  console.log(`GTD Buddy MCP SSE Server running on http://localhost:${PORT}`);
