      ...
      {subscriptionStatus.isInTrial && user?.subscriptionEndDate && (
        <Alert className="mx-4 mt-4 border-yellow-200 bg-yellow-50">
          ...
          <AlertDescription className="text-yellow-800">
            ...
            <Link
              href="https://gtdbuddy.vercel.app/subscription"
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="inbox">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-gray-900 font-heading">Procesar Inbox</h2>
              <Button
                onClick={() => setShowTaskForm(true)}
                className="gtd-gradient-action hover:from-gtd-action-500 hover:to-gtd-action-700 text-white gtd-transition"
              >
          ...
          <TabsContent value="organize">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-gray-900 font-heading">Organizar Tareas</h2>
              <Button
                onClick={() => setShowTaskForm(true)}
                className="gtd-gradient-action hover:from-gtd-action-500 hover:to-gtd-action-700 text-white gtd-transition"
              >
          ...
          <TabsContent value="review">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-gray-900 font-heading">Revisión Semanal</h2>
              <Button
                onClick={() => setShowTaskForm(true)}
                className="gtd-gradient-action hover:from-gtd-action-500 hover:to-gtd-action-700 text-white gtd-transition"
              >
